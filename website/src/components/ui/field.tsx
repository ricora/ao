...
const { description, fieldError, label } = fieldStyles()
...
const Description = ({ className, ref, ...props }: DescriptionProps) => {
  return <Text ref={ref} {...props} className={description({ className })} slot="description" />
}
